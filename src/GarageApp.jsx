...
const LOGO_HEADER_SRC = "data:image/png;base64,"; // triangle + Mr.CAP wordmark, cropped from the real invoice letterhead — used for the prominent centered logo spots (login, kiosk picker, public tracking page), not the tiny inline header icon which stays paired with adjacent text
...
// "Customer informed" tracking, paired with a WhatsAppSendButton at a
// send point. Two modes: mandatory (quote_sent, ready_for_collection —
// the two messages the shop actually always sends, per Suhail) shows
// just the informed checkbox; skippable (job_started, google_review —
...
function CustomerNotifyControl({ record, templateKey, session, onSave, skippable = false }) {
  ...
  const patch = async (fields) => {
    const updated = {
      ...record,
      customerNotify: { ...(record.customerNotify || {}), [templateKey]: { ...notify, ...fields } },
      updatedAt: Date.now(),
    };
    await onSave(updated);
  };

  const rowStyle = { display: "flex", alignItems: "center", gap: 7, fontSize: 12, color: COLORS.muted, padding: "2px 2px 10px", cursor: "pointer" };
  const boxStyle = { width: 15, height: 15, flexShrink: 0, accentColor: COLORS.gold, cursor: "pointer" };

  if (notify.skipped) {
    return (
      <label style={rowStyle}>
        <input type="checkbox" checked style={boxStyle} onChange={() => patch({ skipped: false })} />
        Not needed for this job — WhatsApp skipped
      </label>
    );
  }
    ...
    <div>
      ...
      {skippable && (
        <label style={{ ...rowStyle, marginTop: -6 }}>
          <input type="checkbox" checked={false} style={boxStyle} onChange={() => patch({ skipped: true })} />
...
// "Loading…" as plain text, which felt broken on a slow connection.
function SkeletonRows({ count = 4, height = 64 }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="mrcap-skeleton" style={{ height, border: `1px solid ${COLORS.line}` }} />
      ))}
    </div>
  );
}
...
function JobDetail({ id, initialJob, session, team, onChanged, onBack, canArchive, onDeleted }) {
  ...
  // record with customerNotify already patched, we just persist it the
  // same way every other field on this screen gets persisted.
...
function QuoteDetail({ id, session, team, onBack, onConverted }) {
  ...
  // Passed as onSave to CustomerNotifyControl for the quote-sent message.
  const saveQuoteRecord = async (updated) => {
    await saveQuote(updated);
    setQuote(updated);
  };
...
function ServicesManagementScreen({ onBack }) {
  ...
  if (loading) return <div className="mrcap-view" style={{ padding: "0 18px 30px" }}><SectionTitle>Services & Pricing</SectionTitle><SkeletonRows count={5} height={48} /></div>;
...
// Persistent "Internal Updates" access point — a small floating button
// shown on every screen (not just its own nav tab) for the core 4
// (Ahmed, Lani, Regan, Noel) plus admins, per Suhail's request. Opens
...
export function DispatchKiosk() {
  ...
  if (!ready) {
    return <div style={{ minHeight: "100vh", background: "#0b0b0c", padding: "44px 22px" }}><SkeletonRows count={5} height={48} /></div>;
  }
  ...
  if (picked) {
    return (
      <div className="mrcap-view" style={{ minHeight: "100vh", background: "#0b0b0c", padding: "48px 22px", textAlign: "center" }}>
        <button onClick={() => setPicked(null)} style={{ ...iconBtnStyle, marginBottom: 24 }} className="mrcap-press"><ChevronLeft size={18} color={COLORS.ink} /></button>
        <div style={{ fontFamily: DISPLAY_FONT, fontWeight: 600, fontSize: 20, color: COLORS.ink }}>{picked.name}</div>
        <div style={{ fontSize: 12, color: COLORS.blue, marginTop: 3, marginBottom: 22, letterSpacing: 0.3, textTransform: "uppercase", fontWeight: 700 }}>Admin PIN required</div>
